...
export class EmailMarketingController {
  ...
  @RequirePermissions('automation.view')
  audienceMembers(@CurrentUser() user: AuthUser, @Query() query: AudienceMembersQueryDto) {
    return this.service.listAudienceMembers(user.organizationId, query);
  }
  ...
  @RequirePermissions('automation.campaign.create')
  @UseInterceptors(FileInterceptor('file', createUploadMulterOptions('spreadsheet')))
  importFile(
    @CurrentUser() user: AuthUser,
