...
import { MarketingAutopilotFacebookPublishService } from './orchestrator/marketing-autopilot-facebook-publish.service';
...
@Module({
  ...
  providers: [
    ...
    MarketingAutopilotFacebookPublishService,
    MarketingAutopilotCommandCenterService,
    MarketingAutopilotGuardrailService,
