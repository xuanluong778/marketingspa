        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
          ...
          <main className="lg:col-span-3 space-y-12 text-sm leading-relaxed text-white/90">
            ...
            <section id="1-thu-thap-du-lieu" className="scroll-mt-24 space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  ...
                  Google Ad Account được bạn chủ động tích hợp vào hệ thống.
                </li>
                <li>
            ...
            <section id="4-tich-hop-ben-thu-ba" className="scroll-mt-24 space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Meta (Facebook, Messenger):</strong> Đọc danh sách Fanpage quản lý và đăng
                  bài lên Feed/Photos thông qua API. Khi bạn bật Chatbot CSKH / nhắn tin hàng loạt,
                  hệ thống có thể lưu PSID, hội thoại Messenger và lead gắn với Fanpage đã kết nối
                  để phản hồi và chăm sóc khách hàng trong phạm vi Tổ chức của bạn.
                </li>
                <li>
            ...
            <section id="8-yeu-cau-xoa-du-lieu" className="scroll-mt-24 space-y-4">
              ...
              <div className="rounded-lg border border-white/10 bg-card p-5 space-y-3">
                ...
                <ol className="list-decimal pl-5 space-y-1.5">
                  ...
                  <li>
                    Hệ thống sẽ xác thực và tiến hành xóa toàn bộ thông tin liên quan đến Page ID,
                    mã Page Access Token đã mã hóa, hình ảnh đại diện trang và lịch sử đăng bài liên
                    quan trong vòng <strong>72 giờ làm việc</strong> kể từ khi tiếp nhận.
                  </li>
                </ol>
              </div>
            </section>
