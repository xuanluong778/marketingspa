  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="rounded-lg border border-violet-100 bg-violet-50/60 px-4 py-3 text-sm text-violet-900">
        Chọn bài từ thư viện → duyệt/sửa caption → chọn Fanpage → chọn thời gian (thanh dưới) → lên
        lịch hoặc đăng ngay.
      </div>
          ...
          {selected ? (
            <>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="auto-post-library-caption">Caption (duyệt trước khi đăng)</Label>
                <Textarea
