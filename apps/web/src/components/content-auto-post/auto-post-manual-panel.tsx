    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <div className="rounded-xl border bg-card p-5 shadow-sm space-y-4">
          <h2 className="font-semibold text-lg">{t('facebookFlow.compose')}</h2>
          <div className="space-y-1.5">
            <Label htmlFor="auto-post-manual-content">{t('facebookFlow.contentRequired')}</Label>
            <Textarea
              id="auto-post-manual-content"
              value={caption}
              onChange={(e) => setCaption(e.target.value)}
              rows={12}
              placeholder={t('facebookFlow.contentPlaceholder')}
              autoComplete="off"
              spellCheck
            />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="auto-post-manual-image">{t('facebookFlow.imageUrlOptional')}</Label>
            <Input
          ...
          <div className="space-y-1.5">
            <Label htmlFor="auto-post-manual-link">{t('facebookFlow.landingLinkOptional')}</Label>
            <Input
