...
/**
 * [Chọn Project / Fanpage / OA / Website ▼] [Tất cả | Fanpage | Zalo | Website]
 * Một dropdown bên trái — đổi theo tab kênh (không có dropdown thứ hai bên phải).
 */
export function ChatbotInboxFilters({
  ...
  const oaValue = channelId
    ? (() => {
        ...
        return hit ? `${hit.botId}::${o.accountRef}` : '__all__';
      })()
    : '__all__';
