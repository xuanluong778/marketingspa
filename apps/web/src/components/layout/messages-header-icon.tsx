  ...
  return (
    ...
    >
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={8}
        className="flex w-[min(100vw-1.5rem,22rem)] max-h-[min(60vh,22rem)] flex-col overflow-hidden p-0"
      ...
      >
        ...
        <DropdownMenuItem
          className="shrink-0 cursor-pointer justify-center rounded-none py-2.5 text-sm font-medium text-primary focus:text-primary"
          onSelect={(e) => {
            e.preventDefault();
            setOpen(false);
