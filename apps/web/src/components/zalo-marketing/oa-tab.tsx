...
function oaStatusLabel(oa: ZaloOaItem) {
  if (oa.isPaused) return 'Tạm dừng';
  if (oa.status === 'DISCONNECTED') return 'Đã ngắt';
                  ...
                  return (
                    <tr key={oa.id} className="border-t">
                      ...
                      <td className="px-3 py-2">
                        <Badge variant={isActive ? 'default' : 'outline'}>{oaStatusLabel(oa)}</Badge>
                      </td>
