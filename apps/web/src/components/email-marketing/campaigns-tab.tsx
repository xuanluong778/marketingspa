  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable
        ...
        emptyTitle={t('emailMarketing.emptyCampaigns')}
        columns={[
          {
            key: 'name',
            header: t('emailMarketing.name'),
            cell: (r) => (
              <button
                type="button"
          ...
          {
            key: 'status',
            header: t('emailMarketing.status'),
            cell: (r) => <StatusBadge status={CAMPAIGN_STATUS_LABELS[r.status]} />,
          },
          {
            key: 'audience',
            header: t('emailMarketing.recipients'),
            cell: (r) => r.list?.name || (r.segment?.name ? r.segment.name : t('emailMarketing.allReceiving')),
          },
          {
            key: 'sent',
            header: t('emailMarketing.send'),
