...
export function FunnelAdvancedSection({
  ...
  return (
    <div className="rounded-lg border">
      ...
      >
        <div>
          <p className="text-sm font-medium">Nâng cao</p>
          <p className="text-xs text-muted-foreground">
            Điểm MQL/SQL, phiên bản / khôi phục, và công cụ kỹ thuật.
          </p>
        </div>
        <ChevronDown
        ...
        <div className="space-y-4 border-t px-4 py-4">
          ...
          {pane === 'scoring' ? (
            ...
            <p className="text-sm text-muted-foreground">
              Mở Chỉnh sửa một phễu để xem phiên bản, khôi phục và lưu trữ.
            </p>
          )}
        </div>
      )}
