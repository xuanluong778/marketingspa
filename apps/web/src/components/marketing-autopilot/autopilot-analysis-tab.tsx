    ...
    <div className="space-y-4">
      ...
      <StatCardGrid>
        <InfoCard
          ...
          description={shortText(strategyText, 120)}
          footer={
            <span className="inline-flex rounded-full bg-emerald-500/15 px-2 py-0.5 text-[10px] text-emerald-300">
              Phù hợp mục tiêu
            </span>
          }
        />
        <InfoCard
          tone="blue"
          icon={Users}
          title={t('autopilot.targetCustomers')}
          description={shortText(audienceText, 120)}
          footer={
            <span className="text-[10px] text-sky-300">Nhóm tiềm năng cao</span>
          }
        />
        <InfoCard tone="purple" icon={FileText} title="Tài sản AI đã tạo">
        ...
        <InfoCard tone="amber" icon={Coins} title="Ngân sách đề xuất">
