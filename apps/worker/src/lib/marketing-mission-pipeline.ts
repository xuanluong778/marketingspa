...
type AuthUser = { id: string; organizationId: string; email?: string; name?: string; role?: string };
type AdapterDraftResult = {
...
type MarketingAutopilotDraftType = 'CONTENT_DRAFT' | 'FUNNEL_DRAFT' | 'AUTOMATION_DRAFT' | 'CAMPAIGN_DRAFT';
type MarketingAutopilotPlan = any;
