...
import type { MarketingAutopilotGuardrailConfig } from './marketing-autopilot-guardrail';
...
export const AUTOPILOT_MODES = ['APPROVAL_AUTOPILOT', 'FULL_AUTOPILOT'] as const;
        ...
        : d.kind === 'FUNNEL_BOTTLENECK'
          ...
          : d.kind === 'LEAD_NO_FOLLOWUP'
            ...
            : d.kind === 'AUTOMATION_ERROR'
              ...
              : 'CAMPAIGN',
    correlationOnly: true,
    requiresApproval: autopilotMode === 'APPROVAL_AUTOPILOT',
